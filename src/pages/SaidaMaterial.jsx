...
export function SaidaMaterial({ items, onItemsUpdated, userEmail }) {
  ...
  // Abrir o(s) termo(s) de saída em nova(s) guia(s), já pronta(s) para impressão.
  // Se houver EPIs e outros materiais na mesma saída, abre as duas guias, cada uma só com seus itens.
